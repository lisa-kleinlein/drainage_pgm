...
ggsave(paste0("C:/Users/lisak/OneDrive/Dokumente/Studium/7. Semester/Bachelorarbeit/plots/eval/predictions/pred_summer_X10303_cut.pdf"), width = 13, height = 12)
...
ggsave(paste0("C:/Users/lisak/OneDrive/Dokumente/Studium/7. Semester/Bachelorarbeit/plots/eval/predictions/pred_summer_X10302.pdf"), width = 13, height = 12)
plot_obs_pred_kbo(data_obs_res_kbo = data_res_summer_ps_intera_02_kbo, halfyear = "summer", catchment = "X10302",
                  title = "", all = TRUE, xlim_l = 0, xlim_u = 800, ylim_l = 0, ylim_u = 800)
ggsave(paste0("C:/Users/lisak/OneDrive/Dokumente/Studium/7. Semester/Bachelorarbeit/plots/eval/predictions/pred_summer_X10302_cut.pdf"), width = 13, height = 12)
